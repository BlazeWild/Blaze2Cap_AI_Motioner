"""
GT Motion Visualizer (Z-Up In-Place)
====================================
1. Loads Y-Down Data.
2. Transforms everything to Z-Up.
3. FORCES HIP POSITION TO (0,0,0) (In-Place).
4. Displays Orientation Info Only.
"""
...
def reconstruct_global_motion(data_npy, parents, offsets):
    ...
    **FORCES ROOT POSITION TO (0,0,0) FOR ALL FRAMES**
    """
    ...
    # B. Root Velocity (IGNORED for In-Place, but kept for logic)
    ...
    # ==========================================
    # 3. FK ACCUMULATION LOOP (IN-PLACE MODIFIED)
    # ==========================================
...
def main():
    ...
    fig.suptitle(f"File: {os.path.basename(filepath)} (IN-PLACE)", fontsize=12)
    plt.subplots_adjust(bottom=0.25, left=0.30)
    ...
    # Trajectory line removed since it's just a dot at (0,0,0)
